...
QT_MOC_LITERAL(12, 12), // "colorClicked"
QT_MOC_LITERAL(25, 0), // ""
QT_MOC_LITERAL(26, 4), // "QRgb"
QT_MOC_LITERAL(31, 5), // "color"
QT_MOC_LITERAL(37, 10), // "pairOfInts"
QT_MOC_LITERAL(48, 11), // "coordinates"
QT_MOC_LITERAL(60, 13) // "buttonClicked"

    },
    "colorButton\0colorClicked\0\0QRgb\0color\0"
    "pairOfInts\0coordinates\0buttonClicked"
};
...
void colorButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->colorClicked((*reinterpret_cast< std::add_pointer_t<QRgb>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<pairOfInts>>(_a[2]))); break;
        ...
        {
            using _t = void (colorButton::*)(QRgb , const pairOfInts & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&colorButton::colorClicked)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<colorButton, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QRgb, std::false_type>, QtPrivate::TypeAndForceComplete<const pairOfInts &, std::false_type>
...
// SIGNAL 0
void colorButton::colorClicked(QRgb _t1, const pairOfInts & _t2)
{
